 ...
 * @version 1.0
 */
public class OSCMessageOut extends OSCPacket {
	 ...
	 */
	public OSCMessageOut(String newAddress) {
	 ...
	 */
	public OSCMessageOut(String newAddress, Object[] newArguments) {
		super();
		address = newAddress;
